        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 mt-10 max-w-[80%] mx-auto'>
            <div className='flex flex-col gap-3'>
                <div className='text-center space-y-2 shadow-xl bg-white rounded-xl py-5'>
                    ...
                    <button className='btn w-full bg-white'><FaBell />Snooze 2 weeks</button>
                    <button className='btn w-full bg-white'><RiInboxArchiveFill />Archive</button>
                    <button className='btn w-full bg-white text-red-500'><RiDeleteBin2Line className='text-xl'/>Delete</button>
            </div>
            <div className='col-span-2'>
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
                    <div className='text-center py-5 shadow-md'>
